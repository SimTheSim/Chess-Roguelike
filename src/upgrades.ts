...
export const ALL_UPGRADES: Upgrade[] = [
  ...
  },
  {
    ...
    description: 'Pawns can move 1 square left or right to any empty square.',
    rarity: 'common',
    icon: 'Compass',
    pieceFamily: 'pawn',
  },
  ...
  },
  {
    ...
    description: 'Your pawns promote to Queens upon reaching the 5th row instead of the last one.',
    rarity: 'epic',
    icon: 'Sparkles',
    pieceFamily: 'pawn',
  },
  ...
  },
  {
    ...
    description: 'Your King cannot be captured while at least one friendly piece is adjacent to it.',
    rarity: 'epic',
    icon: 'ShieldCheck',
    pieceFamily: 'king',
  },
  ...
  },
  {
    id: 'sacred-chalice',
    name: 'Sacred Chalice',
    description: 'At round start, your center-left Pawn is replaced by a Rook.',
    rarity: 'epic',
    icon: 'CupSoda',
    pieceFamily: 'general',
  },
  {
    id: 'castling-pawns',
    name: 'Royal Retinue',
    description: 'When you castle, up to 3 Pawns are placed on the squares directly in front of the King.',
    rarity: 'common',
    icon: 'CornerDownRight',
    pieceFamily: 'general',
  },
